export default function Footer() {
  return (
    <footer className="border-t border-terminal-border/30 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="font-mono text-xs text-terminal-muted">
            <span className="text-terminal-green mr-1">❯</span>
            echo "© 2025 RAMAMONJISOA Aina Aneliot — Tous droits réservés"
          </div>
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-terminal-muted/50 font-mono">
            Fait avec <span className="text-red-400">♥</span> et beaucoup de{' '}
